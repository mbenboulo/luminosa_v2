            ...
            <section className="pt-32 pb-16 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
                    ...
                    <motion.div
                        ...
                        className="max-w-4xl"
                    >
                        <div className="inline-block px-4 py-1.5 mb-6 rounded-full bg-blue-900/30 border border-blue-500/30 text-blue-300 text-xs font-bold tracking-wider uppercase">
                            Engineering Specs
                        </div>
